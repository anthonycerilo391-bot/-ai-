  ...
  return (
    <div className="space-y-10 animate-fade-in pb-20 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-end border-b-4 border-black pb-6 gap-6">
        <div>
            <h2 className="text-6xl font-bangers text-white uppercase tracking-wider drop-shadow-md">Step 3. VISUALS</h2>
            <p className="text-gray-400 text-xl font-bold font-comic mt-2">Fine-tune the prompts before drawing.</p>
        </div>
        <button
          onClick={onConfirm}
